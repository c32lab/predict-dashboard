...
export const NODE_COLORS: Record<string, { bg: string; border: string; text: string }> = {
  ...
  theme:          { bg: '#2d1b4e', border: '#8b5cf6', text: '#d8b4fe' },
  sector:         { bg: '#1a3a2a', border: '#22c55e', text: '#86efac' },
  macro:          { bg: '#3d2a00', border: '#f59e0b', text: '#fcd34d' },
  demand_driver:  { bg: '#3d1a2e', border: '#ec4899', text: '#f9a8d4' },
  core:           { bg: '#1a3a2a', border: '#10b981', text: '#6ee7b7' },
  ticker:         { bg: '#1e3a5f', border: '#3b82f6', text: '#93c5fd' },
  upstream:       { bg: '#3d2a00', border: '#f59e0b', text: '#fcd34d' },
  downstream:     { bg: '#0c2e35', border: '#06b6d4', text: '#67e8f9' },
  event:          { bg: '#3d1a1a', border: '#ef4444', text: '#fca5a5' },
}
...
export const NODE_TYPE_COLORS: Record<string, { btn: string; text: string }> = {
  ...
  demand_driver:  { btn: 'bg-pink-900/60 text-pink-300 border border-pink-700',       text: 'text-pink-300' },
  core:           { btn: 'bg-green-900/60 text-green-300 border border-green-700',    text: 'text-green-300' },
  ticker:         { btn: 'bg-blue-900/60 text-blue-300 border border-blue-700',       text: 'text-blue-300' },
  upstream:       { btn: 'bg-amber-900/60 text-amber-300 border border-amber-700',    text: 'text-amber-300' },
  downstream:     { btn: 'bg-cyan-900/60 text-cyan-300 border border-cyan-700',       text: 'text-cyan-300' },
  event:          { btn: 'bg-red-900/60 text-red-300 border border-red-700',          text: 'text-red-300' },
}
